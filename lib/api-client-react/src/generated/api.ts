...
export const getMatchFaqUrl = () => {




  return `/api/faq/match`
}

/**
 * @summary Match a query against FAQ using NLP/TF-IDF cosine similarity
 */
export const matchFaq = async (faqQueryInput: FaqQueryInput, options?: RequestInit): Promise<FaqMatchResult> => {

  return customFetch<FaqMatchResult>(getMatchFaqUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getMatchFaqMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof matchFaq>>, TError,{data: BodyType<FaqQueryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof matchFaq>>, TError,{data: BodyType<FaqQueryInput>}, TContext> => {

const mutationKey = ['matchFaq'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof matchFaq>>, {data: BodyType<FaqQueryInput>}> = (props) => {
          const {data} = props ?? {};

          return  matchFaq(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MatchFaqMutationResult = NonNullable<Awaited<ReturnType<typeof matchFaq>>>
    export type MatchFaqMutationBody = BodyType<FaqQueryInput>
    export type MatchFaqMutationError = ErrorType<unknown>

    /**
 * @summary Match a query against FAQ using NLP/TF-IDF cosine similarity
 */
export const useMatchFaq = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof matchFaq>>, TError,{data: BodyType<FaqQueryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof matchFaq>>,
        TError,
        {data: BodyType<FaqQueryInput>},
        TContext
      > => {
      return useMutation(getMatchFaqMutationOptions(options));
    }
 ...
 */
export const listFaqs = async ( options?: RequestInit): Promise<FaqEntry[]> => {
